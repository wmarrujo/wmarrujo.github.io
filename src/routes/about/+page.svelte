...
<AppShell>
	<AppBar>
		<svelte:fragment slot="lead">
			...
			<a href="/about" class="mx-2 underline">About</a>
			<a href="/notes" class="mx-2 hover:underline">Notes</a>
			<a href="/projects" class="mx-2 hover:underline">Projects</a>
			<a href="/recommendations" class="mx-2 hover:underline">Recommendations</a>
		</svelte:fragment>
	</AppBar>
